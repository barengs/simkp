                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div className="border-b border-gray-200">
                        <nav className="-mb-px flex">
                            <button className="whitespace-nowrap py-4 px-6 border-b-2 font-medium text-sm border-indigo-500 text-indigo-600">
                            ...
                            <button className="whitespace-nowrap py-4 px-6 border-b-2 font-medium text-sm border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">
                                Disetujui ({approvedLogbooks.length})
                            </button>
                            <button className="whitespace-nowrap py-4 px-6 border-b-2 font-medium text-sm border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">
                                Perlu Perbaikan ({needsRevisionLogbooks.length})
                            </button>
                        </nav>
                    </div>
