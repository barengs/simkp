...
import { createTheme } from "../../store/slice/themeSlice";
import { toast } from "react-toastify";
import Modal from "../../components/Modal";

const AddTheme = ({ show, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error("Gagal menambahkan tema: " + error);
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <Modal isOpen={show} onClose={onClose} title="Tambah Tema Baru">
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        placeholder="Contoh: Inovasi Digital untuk Masa Depan"
