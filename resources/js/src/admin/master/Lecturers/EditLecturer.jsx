...
import { updateLecturer } from "../../../store/slice/lecturerSlice";
import { toast } from "react-toastify";
import Modal from "../../../components/Modal";

const EditLecturer = ({ show, onClose, lecturer }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setIsLoading(true);
            await dispatch(updateLecturer({ id: lecturer.id, data: formData })).unwrap();
            toast.success("Data dosen berhasil diperbarui");
            onClose();
        } catch (error) {
            toast.error("Gagal memperbarui dosen: " + error);
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <Modal isOpen={show} onClose={onClose} title="Edit Data Dosen">
