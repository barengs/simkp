        ...
        },
        {
            ...
            cell: row => (
                row.file_url ? (
                    ...
                    >
                        <FileText size={16} className="text-indigo-500 group-hover:text-indigo-200" /> 
                        <span>Buka</span>
                    </a>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 border-b border-gray-50 pb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Lihat dan unduh file draf atau laporan akhir dari mahasiswa di bawah bimbingan Anda.</p>
                </div>
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                <DataTable
                    ...
                    highlightOnHover
                    responsive
                    noDataComponent={<div className="p-8 text-gray-500 text-center italic bg-gray-50/50">Tidak ada riwayat laporan anak bimbingan.</div>}
                />
            </div>
        </div>
    );
